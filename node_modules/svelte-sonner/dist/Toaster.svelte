...
let { invert = false, position = 'bottom-right', hotkey = ['altKey', 'KeyT'], expand = false, closeButton = false, offset = VIEWPORT_OFFSET, mobileOffset = MOBILE_VIEWPORT_OFFSET, theme = 'light', richColors = false, duration = TOAST_LIFETIME, visibleToasts = VISIBLE_TOASTS_AMOUNT, toastOptions = {}, dir = getDocumentDirection(), gap = GAP, loadingIcon: loadingIconProp, successIcon: successIconProp, errorIcon: errorIconProp, warningIcon: warningIconProp, closeIcon: closeIconProp, infoIcon: infoIconProp, containerAriaLabel = 'Notifications', class: className, closeButtonAriaLabel = 'Close toast', ...restProps } = $props();
...
<style global>
	...
	:global(:where([data-sonner-toaster][data-lifted='true'])) {
	...
	:global(:where([data-sonner-toast][data-styled='true'])) :global(:where([data-description])) {
		font-weight: 400;
		line-height: 1.4;
		color: #3f3f3f;
	}

	:global(:where([data-rich-colors='true'][data-sonner-toast][data-styled='true'])
		:where([data-description])) {
		color: inherit;
	}

	:global(:where([data-sonner-toaster][data-sonner-theme='dark'])
		:where([data-description])) {
		color: hsl(0, 0%, 91%);
	}

	:global(:where([data-sonner-toast][data-styled='true'])) :global(:where([data-title])) {
		font-weight: 500;
		line-height: 1.5;
		color: inherit;
	}

	:global(:where([data-sonner-toast][data-styled='true'])) :global(:where([data-icon])) {
		display: flex;
		height: 16px;
		width: 16px;
		position: relative;
	...
	:global(:where([data-sonner-toast][data-promise='true'])) :global(:where([data-icon] > svg)) {
		opacity: 0;
		transform: scale(0.8);
	...
	:global(:where([data-sonner-toast][data-styled='true'])) :global(:where([data-icon] svg)) {
		margin-left: var(--toast-svg-margin-start);
		margin-right: var(--toast-svg-margin-end);
	}

	:global(:where([data-sonner-toast][data-styled='true'])) :global(:where([data-content])) {
		display: flex;
		flex-direction: column;
		gap: 2px;
	}

	:global(:where([data-sonner-toast][data-styled='true'])) :global(:where([data-button])) {
		border-radius: 4px;
		padding-left: 8px;
		padding-right: 8px;
		height: 24px;
	...
	:global(:where([data-sonner-toast][data-styled='true'])) :global(:where([data-cancel])) {
		color: var(--normal-text);
	...
	:global(:where([data-sonner-toast][data-expanded='true'])::after) {
		content: '';
		position: absolute;
		left: 0;
	...
	:global(:where([data-sonner-toast][data-x-position='right'])) {
		right: 0;
	}

	:global(:where([data-sonner-toast][data-x-position='left'])) {
		left: 0;
	}
	...
	:global(:where([data-sonner-toast][data-swiping='true'])) {
		transform: var(--y) translateY(var(--swipe-amount-y, 0px))
			translateX(var(--swipe-amount-x, 0px));
		transition: none;
	}

	:global(:where([data-sonner-toast][data-swiped='true'])) {
		user-select: none;
	}
	...
	:global(:where([data-sonner-toast][data-swipe-out='true'][data-y-position='top'])) {
	...
	:global(:where([data-sonner-toaster][data-sonner-theme='light'])) {
		--normal-bg: #fff;
	...
	:global(:where([data-rich-colors='true'])[data-sonner-toast][data-type='success']) {
	...
	:global(:where([data-rich-colors='true'])[data-sonner-toast][data-type='info']) {
	...
	:global(:where([data-rich-colors='true'])[data-sonner-toast][data-type='warning']) {
	...
	:global(:where([data-rich-colors='true'])[data-sonner-toast][data-type='error']) {
	...
	:global(:where(.sonner-loading-wrapper)) {
		--size: 16px;
		height: var(--size);
		width: var(--size);
		position: absolute;
	...
	:global(:where(.sonner-loading-wrapper[data-visible='false'])) {
		transform-origin: center;
		animation: sonner-fade-out 0.2s ease forwards;
	}

	:global(:where(.sonner-spinner)) {
		position: relative;
		top: 50%;
		left: 50%;
		height: var(--size);
	...
	:global(:where(.sonner-loading-bar)) {
	...
	:global(:where(.sonner-loading-bar:nth-child(1))) {
		animation-delay: -1.2s;
		transform: rotate(0.0001deg) translate(146%);
	}

	:global(:where(.sonner-loading-bar:nth-child(2))) {
		animation-delay: -1.1s;
		transform: rotate(30deg) translate(146%);
	}

	:global(:where(.sonner-loading-bar:nth-child(3))) {
		animation-delay: -1s;
		transform: rotate(60deg) translate(146%);
	}

	:global(:where(.sonner-loading-bar:nth-child(4))) {
		animation-delay: -0.9s;
		transform: rotate(90deg) translate(146%);
	}

	:global(:where(.sonner-loading-bar:nth-child(5))) {
		animation-delay: -0.8s;
		transform: rotate(120deg) translate(146%);
	}

	:global(:where(.sonner-loading-bar:nth-child(6))) {
		animation-delay: -0.7s;
		transform: rotate(150deg) translate(146%);
	}

	:global(:where(.sonner-loading-bar:nth-child(7))) {
		animation-delay: -0.6s;
		transform: rotate(180deg) translate(146%);
	}

	:global(:where(.sonner-loading-bar:nth-child(8))) {
		animation-delay: -0.5s;
		transform: rotate(210deg) translate(146%);
	}

	:global(:where(.sonner-loading-bar:nth-child(9))) {
		animation-delay: -0.4s;
		transform: rotate(240deg) translate(146%);
	}

	:global(:where(.sonner-loading-bar:nth-child(10))) {
		animation-delay: -0.3s;
		transform: rotate(270deg) translate(146%);
	}

	:global(:where(.sonner-loading-bar:nth-child(11))) {
		animation-delay: -0.2s;
		transform: rotate(300deg) translate(146%);
	}

	:global(:where(.sonner-loading-bar:nth-child(12))) {
	...
	:global(:where(.sonner-loader[data-visible='false'])) {
		opacity: 0;
